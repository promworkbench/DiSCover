...
public class ActivityLog {
	...
	/*
	 * Whether the activity is part of a trace classified positive.
	 * If so, the DF relation from its predecessor to it should not be treated as noise. 
	 */
	...
	public ActivityLog(XLog log, XEventClassifier classifier, ActivityAlphabet alphabet) {
		...
		for (XTrace trace : log) {
			...
			if (!isNeg) {
				...
				/*
				 * Trace is classified as negative. 
				 * As a result, we will just skip this trace.
				 */
				size--;
			}
		}
	 ...
	 * 
	 * @param idx
	 *            The given index in the activity log
